			...
			<div class="col-span-3 px-4">
				<header class="entry-header">
					...
					<?php if ( get_post_meta( get_the_ID(), 'ecpt_external_link', true ) ) : ?>
						<?php the_title( '<h2 class="entry-title text-3xl! mt-2!"><a class="archive-post" href="' . esc_url( get_post_meta( $post->ID, 'ecpt_external_link', true ) ) . '" rel="bookmark">', ' <i class="fa-regular fa-square-arrow-up-right"></i></a></h2>' ); ?>
					<?php else : ?>

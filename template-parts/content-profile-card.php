...
<figure class="profile-card p-2 w-full lg:w-1/3 m-0!">
	<div class="h-full px-6 py-4 mb-4">
		<?php if ( has_post_thumbnail() ) : ?>
			...
			<?php
				the_post_thumbnail(
					'large',
					array(
						'class' => 'not-prose w-full h-full object-cover object-top',
		...
		<blockquote class="relative flex flex-wrap items-center border-none quote">
			<svg class="absolute -top-4 -inset-s-4 size-12 text-grey" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">

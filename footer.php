...
<footer class="site-footer bg-old-black text-white mt-20 border-t-1 border-grey-darkest relative">
	...
	<div class="py-6 px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
		...
		if ( $department_email || $department_phone || $department_location || $department_social ) :
			...
			<p class="text-lg"><span class="fa-solid fa-envelope"></span> <a class="font-sans font-light hover:text-blue-light" href="<?php echo esc_url( 'mailto:' . antispambot( get_field( 'department_email', 'option' ) ) ); ?>"><?php echo esc_html( antispambot( get_field( 'department_email', 'option' ) ) ); ?></a></p>
			<?php endif; ?>
			<?php if ( $department_phone ) : ?>
			<p class="text-lg"><span class="fa-solid fa-phone-rotary"></span> <a class="font-sans font-light hover:text-blue-light" href="tel:<?php the_field( 'department_phone', 'option' ); ?>"><?php the_field( 'department_phone', 'option' ); ?></a></p>
			<?php endif; ?>
			<?php if ( $department_location ) : ?>
				<p class="text-lg">
					...
					?>
					<a class="font-sans font-light hover:text-blue-light" href="https://www.google.com/maps/search/?api=1&query=<?php echo esc_html( $address ); ?>" target="_blank">
			...
			<?php if ( have_rows( 'department_social', 'option' ) ) : ?>
				...
				<p class="text-lg">
					<a class="hover:text-blue-light" href="<?php echo esc_attr( the_sub_field( 'department_social_link' ) ); ?>">
		...
		<div class="m-2 lg:m-4 mt-6 col-span-4 lg:col-span-1 lg:mx-auto justify-end">
			<a class="hover:text-blue-light" href="https://facebook.com/JHUArtsSciences"><span class="fa-brands fa-facebook fa-2x pr-2"></span><span class="sr-only">Follow us on Facebook</span></a>
			<a class="hover:text-blue-light" href="https://www.instagram.com/JHUArtsSciences/"><span class="fa-brands fa-instagram fa-2x pr-2"></span><span class="sr-only">Follow us on Instagram</span></a>
			<a class="hover:text-blue-light" href="https://bsky.app/profile/jhuartssciences.bsky.social"><span class="fa-brands fa-bluesky fa-2x pr-2"></span><span class="sr-only">Follow us on Bluesky</span></a>
			<a class="hover:text-blue-light" href="https://www.youtube.com/user/jhuksas"><span class="fa-brands fa-youtube fa-2x pr-2"></span><span class="sr-only">Follow us on YouTube</span></a>
			<a class="hover:text-blue-light" href="https://www.tiktok.com/@jhuartssciences"><span class="fa-brands fa-tiktok fa-2x"></span><span class="sr-only pr-2">TFollow us on ikTok</span></a>
		</div>
	</div>
	<div class="flex flex-wrap bg-original-black py-6 px-4 justify-between">
		...
		<div>
			...
			<ul class="lg:flex lg:flex-wrap lg:justify-between text-lg" role="menu" aria-label="University Policies">
				...
				<li class="pl-4" role="menuitem"><a class="font-sans font-light hover:text-blue-light" href="https://accessibility.jhu.edu/">Accessibility</a></li>
				<li class="pl-4" role="menuitem"><a class="font-sans font-light hover:text-blue-light" href="https://it.johnshopkins.edu/policies/privacystatement">Privacy Statement</a></li>
				<li class="pl-4" role="menuitem"><a class="font-sans font-light hover:text-blue-light" href="https://policies.jhu.edu/">University Policy & Document Library</a></li>
			</ul>
		</div>
	</div>
</footer><!-- #colophon -->

...
if ( is_page( 'graduate' ) || 'graduate' == $ancestor_slug ) :
	...
	<?php if ( is_active_sidebar( 'graduate-sb' ) ) : ?>
		<div class="container mx-auto mt-4 prose graduate-sidebar sidebar widget-area sm:prose lg:prose-lg lg:mt-8">
...
<?php if ( is_page( 'undergraduate' ) || 'undergraduate' == $ancestor_slug ) : ?>
	<?php if ( is_active_sidebar( 'undergrad-sb' ) ) : ?>
		...
		<div class="container mx-auto mt-4 prose undergraduate-sidebar sidebar sm:prose lg:prose-lg lg:mt-8">

...
<div class="tribe-events-c-top-bar__datepicker">
	<button
		...
		type="button"
		aria-label="<?php esc_attr_e( 'Click to toggle datepicker of past or upcoming events', 'the-events-calendar' ); ?>"
		title="<?php esc_attr_e( 'Click to toggle datepicker of past or upcoming events', 'the-events-calendar' ); ?>"
	>
		<time
		...
		<?php endif; ?>
		<?php $this->template( 'components/icons/caret-down', array( 'classes' => array( 'tribe-events-c-top-bar__datepicker-button-icon-svg' ) ) ); ?>
	</button>
	<label
	...
	<template class="tribe-events-c-top-bar__datepicker-template-prev-icon">
		<?php $this->template( 'components/icons/caret-left', array( 'classes' => array( 'tribe-events-c-top-bar__datepicker-nav-icon-svg' ) ) ); ?>
	</template>
	<template class="tribe-events-c-top-bar__datepicker-template-next-icon">
		<?php $this->template( 'components/icons/caret-right', array( 'classes' => array( 'tribe-events-c-top-bar__datepicker-nav-icon-svg' ) ) ); ?>
	</template>
</div>

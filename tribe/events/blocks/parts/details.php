 ...
 * @var int Event post id
 */
$time_title = apply_filters( 'tribe_events_single_event_time_title', __( 'Time:', 'ksas-dept-tailwind' ), $event_id );
...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	...
	<dl>
		...
		if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
			...
			<dt> <?php esc_html_e( 'Start:', 'ksas-dept-tailwind' ); ?> </dt>
			<dd>
			...
			<dt> <?php esc_html_e( 'End:', 'ksas-dept-tailwind' ); ?> </dt>
			<dd>
		...
		elseif ( tribe_event_is_all_day() ):
			...
			<dt> <?php esc_html_e( 'Date:', 'ksas-dept-tailwind' ); ?> </dt>
			<dd>
				<abbr class="tribe-events-abbr tribe-events-start-datetime published dtstart" title="<?php echo esc_attr( $start_ts ); ?>"> <?php echo esc_html( $start_date ); ?> </abbr>
			</dd>
		...
		// Event Cost
		if ( ! empty( $cost ) ) : ?>
			<dt> <?php esc_html_e( 'Cost:', 'ksas-dept-tailwind' ); ?> </dt>
		...
		if ( ! empty( $website ) ) : ?>
			...
			<dt> <?php esc_html_e( 'Website:', 'ksas-dept-tailwind' ); ?> </dt>

...
function ksas_department_tailwind_widgets_init() {
	register_sidebar(
		array(
			...
			'before_title'  => '<h2 class="font-serif-semibold widget-title font-weight-semibold">',
			'after_title'   => '</h2>',
		)
	);
	register_sidebar(
	...
	register_sidebar(
		array(
			...
			'before_widget' => '<div class="widget-area"><aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside></div>',
			'before_title'  => '<h2 class="text-2xl font-serif-semibold widget-title font-weight-semibold">',
			'after_title'   => '</h2>',
		)
	);
	register_sidebar(

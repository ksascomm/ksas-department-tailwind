...
if ( function_exists( 'register_block_pattern' ) ) {
	...
	register_block_pattern(
		...
		array(
			...
			<div class="wp-block-column is-vertically-aligned-center"><!-- wp:cover {"url":"http://sites.krieger.jhu.edu/wp-content/themes/ksas-department-tailwind/resources/images/campus3.jpg","id":1869,"dimRatio":0,"minHeight":500,"style":{"color":{}}} -->
			<div class="wp-block-cover" style="min-height:500px"><img class="wp-block-cover__image-background wp-image-1869" alt="" src="http://sites.krieger.jhu.edu/wp-content/themes/ksas-department-tailwind/resources/images/campus3.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"></div></div>
			<!-- /wp:cover --></div>
			<!-- /wp:column --></div>
			<!-- /wp:columns -->',
		)
	...
	register_block_pattern(
		...
		array(
			'title'         => esc_html__( 'Featured Content', 'ksas-department-tailwind' ),
			'categories'    => array( 'ksas-department-tailwind' ),
			'viewportWidth' => 1400,
			'content'       => implode(
				'',
				array(
					...
					'<figure class="wp-block-image size-full"><img src="' . esc_url( get_template_directory_uri() ) . '/resources/images/campus1.jpg" alt="' . esc_attr__( 'Abstract Rectangles', 'ksas-department-tailwind' ) . '"/></figure>',
					'<!-- /wp:image -->',
					'<!-- wp:heading -->',
					'<h2>' . esc_html__( 'Works and Days', 'ksas-department-tailwind' ) . '</h2>',
					'<!-- /wp:heading -->',
					'<!-- wp:paragraph {"fontSize":"larger"} -->',
					'<p>' . esc_html__( 'August 1 — December 1', 'ksas-department-tailwind' ) . '</p>',
					'<!-- /wp:paragraph -->',
					'<!-- wp:button {"align":"left","className":"is-style-fill"} -->',
					'<div class="wp-block-button alignleft is-style-fill"><a class="wp-block-button__link" href="#">' . esc_html__( 'Read More', 'ksas-department-tailwind' ) . '</a></div>',
					'<!-- /wp:button --></div>',
					'<!-- /wp:column -->',
					'<!-- wp:column -->',
					'<div class="wp-block-column"><!-- wp:image {sizeSlug":"full"} -->',
					'<figure class="wp-block-image size-full"><img src="' . esc_url( get_template_directory_uri() ) . '/resources/images/campus2.jpg" alt="' . esc_attr__( 'Abstract Rectangles', 'ksas-department-tailwind' ) . '"/></figure>',
					'<!-- /wp:image -->',
					'<!-- wp:heading -->',
					'<h2>' . esc_html__( 'The Life I Deserve', 'ksas-department-tailwind' ) . '</h2>',
					'<!-- /wp:heading -->',
					'<!-- wp:paragraph {"fontSize":"larger"} -->',
					'<p>' . esc_html__( 'August 1 — December 1', 'ksas-department-tailwind' ) . '</p>',
					'<!-- /wp:paragraph -->',
	...
	register_block_pattern(
		...
		array(
			'title'         => esc_html__( 'Introduction', 'ksas-department-tailwind' ),
			'categories'    => array( 'ksas-department-tailwind' ),
			'viewportWidth' => 1400,
			'content'       => implode(
				'',
	...
	// Four Column Feature.
	register_block_pattern(
		'ksas-department-tailwind/four-column-feature',
		array(
			'title'         => esc_html__( 'Four Column Features', 'ksas-department-tailwind' ),
			'categories'    => array( 'ksas-department-tailwind' ),
			'viewportWidth' => 1400,
			'content'       => '
	...
	register_block_pattern(
		...
		array(
			'title'         => esc_html__( 'Call to Action', 'ksas-department-tailwind' ),
			'categories'    => array( 'ksas-department-tailwind' ),
			'viewportWidth' => 1400,
			'content'       => implode(
				'',
				array(
					...
					'<h2 class="has-text-align-center">' . esc_html__( 'Support the Museum and Get Exclusive Offers', 'ksas-department-tailwind' ) . '</h2>',
					'<!-- /wp:heading -->',
					'<!-- wp:paragraph {"align":"center"} -->',
					'<p class="has-text-align-center">' . esc_html__( 'Members get access to exclusive exhibits and sales. Our memberships cost $99.99 and are billed annually.', 'ksas-department-tailwind' ) . '</p>',
					'<!-- /wp:paragraph -->',
					'<!-- wp:button {"align":"center","className":"is-style-fill"} -->',
					'<div class="wp-block-button aligncenter is-style-fill"><a class="wp-block-button__link" href="#">' . esc_html__( 'Become a Member', 'ksas-department-tailwind' ) . '</a></div>',
					'<!-- /wp:button --></div></div>',
					'<!-- /wp:group --></div></div>',
					'<!-- /wp:group -->',
				)
	...
	register_block_pattern(
		...
		array(
			'title'         => esc_html__( 'Double Call to Action', 'ksas-department-tailwind' ),
			'categories'    => array( 'ksas-department-tailwind' ),
			'viewportWidth' => 1400,
			'content'       => implode(
				'',
				array(
					...
					'<h2 class="has-text-align-center">' . esc_html__( 'The Museum', 'ksas-department-tailwind' ) . '</h2>',
					'<!-- /wp:heading -->',
					'<!-- wp:paragraph {"align":"center"} -->',
					'<p class="has-text-align-center">' . esc_html__( 'Award-winning exhibitions featuring internationally-renowned artists.', 'ksas-department-tailwind' ) . '</p>',
					'<!-- /wp:paragraph -->',
					'<!-- wp:buttons {"align":"center"} -->',
					'<div class="wp-block-buttons aligncenter"><!-- wp:button {"className":"is-style-fill"} -->',
					'<div class="wp-block-button is-style-fill"><a class="wp-block-button__link">' . esc_html__( 'Read More', 'ksas-department-tailwind' ) . '</a></div>',
					'<!-- /wp:button --></div>',
					'<!-- /wp:buttons --></div></div>',
					'<!-- /wp:group --></div>',
					'<!-- /wp:column -->',
					...
					'<h2 class="has-text-align-center">' . esc_html__( 'The Store', 'ksas-department-tailwind' ) . '</h2>',
					'<!-- /wp:heading -->',
					'<!-- wp:paragraph {"align":"center"} -->',
					'<p class="has-text-align-center">' . esc_html__( 'An awe-inspiring collection of books, prints, and gifts from our exhibitions.', 'ksas-department-tailwind' ) . '</p>',
					'<!-- /wp:paragraph -->',
					'<!-- wp:buttons {"align":"center"} -->',
					'<div class="wp-block-buttons aligncenter"><!-- wp:button {"className":"is-style-fill"} -->',
					'<div class="wp-block-button is-style-fill"><a class="wp-block-button__link">' . esc_html__( 'Shop Now', 'ksas-department-tailwind' ) . '</a></div>',
					'<!-- /wp:button --></div>',
					'<!-- /wp:buttons --></div></div>',
					'<!-- /wp:group --></div>',
					'<!-- /wp:column --></div>',
	...
	register_block_pattern(
		...
		array(
			'title'         => esc_html__( 'Horizontal Call to Action', 'ksas-department-tailwind' ),
			'categories'    => array( 'ksas-department-tailwind' ),
			'viewportWidth' => 1400,
			'content'       => '
